...
{
    /// <inheritdoc />
    public partial class AddSalesOrdersAndDeliveryChallans : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerPoReference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    TransportChargeGST = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesOrderDetails_Designs_DesignId",
                        column: x => x.DesignId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeliveryChallanItems_SalesOrderDetails_SalesOrderDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryChallanItems_SalesOrderDetailId",
                table: "DeliveryChallanItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderDetails_DesignId",
