...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!db.ProductionOrders.Any())
    {
        ...
        db.ProductionOrders.AddRange(
            ...
            new ProductionOrder { DesignId = design3.Id, LotNo = "LOT-003", FabricType = "Georgette", TotalQuantity = 75, Status = OrderStatus.ReadyToDispatch, IsRawMaterialVerified = true, IsDyingVerified = true, IsHandworkVerified = true, IsStitchingVerified = true }
        );
        db.SaveChanges();
